...
> 2. 🍽️ **Restaurant Order Management System**  
...
> ISP allows splitting interfaces so each role only implements what they actually use, like `takeOrder()` for Waiters and `prepareDish()` for Chefs.
...
> **Admin**, **Content Creator**, and **User** may have different responsibilities (e.g., uploading, managing, or viewing content).  
